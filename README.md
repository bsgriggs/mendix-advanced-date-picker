...
| Single                                                                            | Range                                                                    |
| --------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| ![Demo](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/Demo.png) | ![range](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/range.png) |
...
Want to help with translations & accessibility? Submit an issue on [GitHub](https://github.com/bsgriggs/mendix-advanced-date-picker/issues)
...
| Single                                                                                                      | Range                                                                                          |
| ----------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| ![generalDateSingle](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/generalDateSingle.png) | ![generalDateMulti](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/generalDateMulti.png) |
...
-   Year - Uses format yyyy (e.g. 2023)  
    ![year](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/year.png)
...
![time](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/time.png)  
...
![SelectableDates](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/SelectableDates.png)
...
| ------------- | ------------- |  
| ![specificDaysDomain](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/specificDaysDomain.png) | ![specificDays](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/specificDays.png) |
...
| Domain | Widget Properties |  
| ------------- | ------------- |  
| ![intervalDaysDomain](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/intervalDaysDomain.png) | ![intervalDays](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/intervalDays.png) |
...
![SelectableTimes](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/SelectableTimes.png)  
...
| Domain                                                                                                          | Widget Properties                                                                                   |
| --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------- |
| ![specificTimesDomain](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/specificTimesDomain.png) | ![specificTimes](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/specificTimes.png) |

### Customization

![Customization](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/Customization.png)
...
![todayButton](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/todayButton.png)  
...
| ------------- | ------------- |  
| ![monthDisplayForward](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/monthDisplayForward.png) | ![monthDisplayBackward](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/monthDisplayBackward.png) |

**Show inline** - When true, the calendar is rendered directly on the page instead of an input with a popup.  
![showInline](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/showInline.png)  
**Show week numbers** - When true, the day calendar will show week numbers as a column inside the popup.  
![showWeekNumbers](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/showWeekNumbers.png)  
**Show arrow** - When true, shows a small arrow pointing the calendar to the input.  
![showArrow](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/showArrow.png)  
**Alignment** - Determines which side the popup is aligned with on the text box.  
| Left (Default) | Right | Auto |  
| ------------- | ------------- | ------------- |  
| ![alignRight](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/alignRight.png) | ![alignLeft](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/alignLeft.png) | ![alignAuto](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/alignAuto.png) |

### Events

![Events](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/events.png)  
...
![Accessibility](https://github.com/bsgriggs/mendix-advanced-date-picker/blob/media/Accessibility.png)  
...
https://widgettesting105-sandbox.mxapps.io/p/advanced-date-picker

## Issues, suggestions and feature requests

https://github.com/bsgriggs/mendix-advanced-date-picker/issues
