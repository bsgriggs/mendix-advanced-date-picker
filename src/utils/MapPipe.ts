...
// ): (conformedValue: string, config: PipeConfig) => false | string | { value: string; indexesOfPipedChars: number[] } {
//     const dateFormatArray = dateFormat
//         .split(/[^dmyHMS]+/)
//         .sort((a, b) => formatOrder.indexOf(a) - formatOrder.indexOf(b));
//     return function (conformedValue: string): false | string | { value: string; indexesOfPipedChars: number[] } {
